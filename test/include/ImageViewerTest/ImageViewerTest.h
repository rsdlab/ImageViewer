...
#ifndef IMAGEVIEWER_TEST__H
#define IMAGEVIEWER_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ImageViewerTest(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ImageViewerTestInit(RTC::Manager* manager);
};

#endif // IMAGEVIEWER_TEST_H
